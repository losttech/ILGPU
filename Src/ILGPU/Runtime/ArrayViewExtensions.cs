...
namespace ILGPU.Runtime
{
    ...
    public static partial class ArrayViewExtensions
    {
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static void CopyToCPUAsync<T, TView>(
            this TView source,
            out T cpuData,
            long length)
            where TView : IContiguousArrayView<T>
            where T : unmanaged =>
            source.CopyToCPUAsync(
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static void CopyFromCPUAsync<T, TView>(
            this TView target,
            ref T cpuData,
            long length)
            where TView : IContiguousArrayView<T>
            where T : unmanaged =>
            target.CopyFromCPUAsync(
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static void CopyToCPUSync<T, TView>(
            this TView source,
            out T cpuData,
            long length)
            where TView : IContiguousArrayView<T>
            where T : unmanaged =>
            source.CopyToCPUSync(
                source.GetDefaultStream(),
                out cpuData,
                length);
        ...
        public static void CopyToCPUSync<T, TView>(
            ...
            where T : unmanaged
        {
            source.CopyToCPUSync(stream, out cpuData, length);
            stream?.Synchronize();
        }
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static void CopyFromCPUSync<T, TView>(
            this TView target,
            ref T cpuData,
            long length)
            where TView : IContiguousArrayView<T>
            where T : unmanaged =>
            target.CopyFromCPUSync(
                target.GetDefaultStream(),
                ref cpuData,
                length);
        ...
        public static void CopyFromCPUSync<T, TView>(
            ...
            where T : unmanaged
        {
            target.CopyFromCPUAsync(stream, ref cpuData, length);
            stream?.Synchronize();
        }
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static unsafe void CopyToCPUSync<T, TView>(
            this TView source,
            AcceleratorStream stream,
            in Span<T> span)
            where TView : IContiguousArrayView<T>
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        [NotInsideKernel]
        public static unsafe void CopyFromCPUSync<T, TView>(
            this TView target,
            AcceleratorStream stream,
        ...
        public static void CopyToCPUSync<T>(
            ...
            T[] data)
            where T : unmanaged =>
            ((ArrayView1D<T, Stride1D.Dense>)view).CopyToCPUSync(data);
        ...
        public static unsafe void CopyToCPUSync<T>(
            ...
            T[] data)
            where T : unmanaged =>
            ((ArrayView1D<T, Stride1D.Dense>)view).CopyToCPUSync(stream, data);
        ...
        public static void CopyFromCPUSync<T>(
            ...
            T[] data)
            where T : unmanaged =>
            ((ArrayView1D<T, Stride1D.Dense>)view).CopyFromCPUSync(data);
        ...
        public static void CopyFromCPUSync<T>(
            ...
            T[] data)
            where T : unmanaged =>
            ((ArrayView1D<T, Stride1D.Dense>)view).CopyFromCPUSync(stream, data);
            ...
            where T : unmanaged
        {
            ...
            view.CopyToCPUSync(stream, new Span<T>(result, 0, result.Length));
            return result;
        }
