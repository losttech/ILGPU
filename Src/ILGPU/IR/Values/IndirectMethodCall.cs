...
namespace ILGPU.IR.Values
{
    ...
    public sealed class IndirectMethodCall : Value
    {
        #region Nested Types
        ...
        /// Returns the call target.
        /// </summary>
        public ValueReference Target { get; }
        ...
        protected override string ToPrefixString() => "calli";
