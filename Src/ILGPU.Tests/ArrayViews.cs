...
namespace ILGPU.Tests
{
    public abstract class ArrayViews : TestBase
    {
        ...
        public void ArrayViewLea(int length)
        {
            ...
            {
                source.CopyFromCPUSync(Accelerator.DefaultStream, expected);
            ...
            int subViewLength)
        {
            ...
            source.CopyFromCPUSync(Accelerator.DefaultStream, data);
        ...
        public void ArrayViewGetSubVariableView(int length)
        {
            ...
            {
                source.CopyFromCPUSync(Accelerator.DefaultStream, sourceData);
                Execute(length, buffer.View, source.View);
            }
        ...
        public void ArrayViewMultidimensionalAccess(long length)
        {
            ...
            {
                source.AsContiguous().CopyFromCPUSync(
